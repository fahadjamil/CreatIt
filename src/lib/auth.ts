...
const getAuthSession = (): AuthSession | null => safeParse(getCookie(AUTH_STORAGE_KEY));
 ...
 */
const extractAuthTokens = (responseData: unknown): AuthTokens => {
  const data = (responseData ?? null) as any;
